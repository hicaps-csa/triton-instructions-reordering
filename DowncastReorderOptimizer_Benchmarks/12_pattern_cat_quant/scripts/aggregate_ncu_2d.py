"""Aggregate ncu CSVs from the 2-D cat-quant sweep into a focused report."""
import csv
import os
from pathlib import Path

RUN_DIR = Path("/tmp/ncu_runs_2d")
...
def main():
    ...
    with open(TXT_PATH, "w") as f:
        w = f.write
        w("=" * 96 + "\n")
        w("  ncu detailed profiling -- 2-D cat_quant_2d_kernel @ M = N = 8192\n")
        ...
        w("    win     -> 7.09x speedup case from nsys sweep\n")
        w("    big     -> 1.29x partial win; ON still BW-poor (<100 GB/s)\n\n")
