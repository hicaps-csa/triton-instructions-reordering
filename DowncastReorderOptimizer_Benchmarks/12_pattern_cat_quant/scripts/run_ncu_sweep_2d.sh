#!/bin/bash
# ncu detailed profiling for 2-D cat-quant kernel.
...
PYBIN="${PYBIN:-python3}"
SCRIPT=$PATTERN_DIR/kernels/test_cat_quant_2d.py
RUN_DIR=/tmp/ncu_runs_2d
...
CONFIGS=(
  ...
  "win     128 256"    # tile = 32768  (headline 7.09x case)
  "big     256 256"    # tile = 65536  (1.29x; ON still BW-poor)
)
M=8192
N=8192
ITERS=10
