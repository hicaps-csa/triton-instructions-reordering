#!/bin/bash
# ncu detailed profiling for 2-D multi_consumer_trans_trunc kernel.
...
RUN_DIR=/tmp/ncu_runs_mctt
TRITON_DEFAULT_CACHE="$HOME/.triton/cache"

mkdir -p "$RUN_DIR"

# Tile labels follow cat_trunc_2d convention: neutral / mid / win / big.
# Update post-nsys-sweep if a different tile is the headline.
CONFIGS=(
  "neutral 64  64"
  "mid     128 128"
  "win     128 256"
