"""Aggregate ncu CSVs from the 2-D deep-chain sweep into a focused report."""
import csv
from pathlib import Path

RUN_DIR = Path("/tmp/ncu_runs_deep_chain")
...
def main():
    ...
    with open(TXT_PATH, "w") as f:
        w = f.write
        w("=" * 96 + "\n")
        w("  ncu detailed profiling -- 2-D deep_chain_2d_kernel @ M = N = 8192\n")
