#!/bin/bash
# ncu detailed profiling for multi_consumer_cat_3kind_2d (Experiment A1).
# 4 configs (neutral / mid / win / big) x 2 pass states = 8 captures @ M=N=8192.
